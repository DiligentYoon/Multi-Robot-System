...
#                  w_free: float = 1.0,
#                  w_unknown: float = 1.0) -> np.ndarray | None:
#     """
...
#             # --- NEW: FREE / UNKNOWN 가중치 ---
#             cell_type = belief[neighbor_pos]  # 원래 belief 기준
#             if cell_type == map_mask["free"]:
#                 move_cost *= w_free
#             elif cell_type == map_mask["unknown"]:
#                 move_cost *= w_unknown
#             # goal / 기타 타입은 기본 비용 유지 (원하면 여기도 케이스 추가 가능)
